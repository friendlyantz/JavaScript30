describe('empty spec', () => {
  it('passes', () => {
    ...
    cy.get('.keys > [data-key="65"]').trigger('keydown', { keyCode: 65 })
    ...
    cy.get('.keys > [data-key="83"]').trigger('keydown', { keyCode: 83 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
    ...
    cy.get('.keys > [data-key="68"]').trigger('keydown', { keyCode: 68 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
    ...
    cy.get('.keys > [data-key="70"]').trigger('keydown', { keyCode: 70 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
    ...
    cy.get('.keys > [data-key="71"]').trigger('keydown', { keyCode: 71 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
    ...
    cy.get('.keys > [data-key="72"]').trigger('keydown', { keyCode: 72 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
    ...
    cy.get('.keys > [data-key="74"]').trigger('keydown', { keyCode: 74 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
    ...
    cy.get('.keys > [data-key="75"]').trigger('keydown', { keyCode: 75 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
    ...
    cy.get('.keys > [data-key="76"]').trigger('keydown', { keyCode: 76 })
      .should('have.class', 'playing')
      .wait(200)
      .should('not.have.class', 'playing');
  });
